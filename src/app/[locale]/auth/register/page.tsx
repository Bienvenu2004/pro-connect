        ...
        <div className="rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a] p-6 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-[#1a1a1a] px-4 text-gray-500">{t("common.or")}</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <span className={`block text-sm font-semibold ${role === "CLIENT" ? "text-orange-400" : "text-gray-200"}`}>
                    {t("auth.roleClient")}
                  </span>
                ...
                >
                  <span className={`block text-sm font-semibold ${role === "PROFESSIONAL" ? "text-orange-400" : "text-gray-200"}`}>
                    {t("auth.rolePro")}
                  </span>
                  <span className="block text-xs text-gray-500 mt-0.5">
                    {t("auth.roleProDesc")}
            ...
            {role === "PROFESSIONAL" && (
              <div>
                ...
                <select
                  ...
                  name="category"
                  required
                  className="mt-1 block w-full rounded-xl border border-[#3a3a3a] bg-[#2a2a2a] px-4 py-3 text-white focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition"
                >
                  {CATEGORIES.map((cat) => (
